...
const AbilityCooldown: React.FC<AbilityCooldownProps> = ({ cooldown, maxCooldown, abilityName }) => {
  ...
  return (
    <div className="fixed bottom-[62px] right-4 z-[15] w-[106px] rounded-[var(--radius-xl)] border-2 border-[var(--color-hud-border)] bg-[var(--color-hud-bg)] p-2 text-center shadow-[var(--shadow-hud)] backdrop-blur-md">
