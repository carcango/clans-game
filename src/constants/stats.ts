...
export const CLASS_STATS: Record<string, ClassStats> = {
  warrior: {
    hp: 150, stamina: 100, speed: 7, attackMin: 23, attackMax: 40,
    ...
    ability2Cost: 25, ability2CooldownMax: 10,
  },
  archer: {
    hp: 80, stamina: 120, speed: 8, attackMin: 12, attackMax: 20,
    ...
    ability2Cost: 15, ability2CooldownMax: 5,
  },
  mage: {
    hp: 70, stamina: 150, speed: 6.5, attackMin: 20, attackMax: 32,
    ...
    ability2Cost: 20, ability2CooldownMax: 8,
  },
  paladin: {
    hp: 165, stamina: 90, speed: 6.5, attackMin: 21, attackMax: 35,
    ...
    ability2Cost: 30, ability2CooldownMax: 12,
  },
  rogue: {
    hp: 85, stamina: 130, speed: 10, attackMin: 25, attackMax: 44,
    ...
    ability2Cost: 20, ability2CooldownMax: 6,
  },
  necromancer: {
    hp: 90, stamina: 140, speed: 6, attackMin: 16, attackMax: 24,
    ...
    ability2Cost: 35, ability2CooldownMax: 10,
  },
};
